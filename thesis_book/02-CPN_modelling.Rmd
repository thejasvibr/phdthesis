...
d.rownames <- c("Intercept", "Heading variation ($^{\\circ}$)", "Acoustic shadowing", "Interpulse interval (ms)", NA,NA,NA,NA, "Minimum interbat distance (m)", "Sound duration (ms)", "Source level (dB SPL re 20 $\\mu$ Pa at 1m)", NA, NA, NA, "Atmospheric attenuation (dB/m)")

values <- data.frame(rbind(c(NA, NA, 0.32, 0.31, 0.35, -1.11, 0.027, -40.51, 0.0),
							c("$\\pm$90", "$\\pm$", "1.32", "1.28", "1.36", "0.28", "0.015", "18.35", "0.0"),
							c("Yes", "No", "0.75", "0.73", "0.78", "-0.28", "0.015", "18.63","0.0"),
							c("25","100","0.001","0.0009","0.001", "-6.84","0.073","-93.52",
							"0.0"),
							c(NA, NA, 0.32, 0.31, 0.35, -1.11, 0.027, -40.51, 0.0),
							c(NA, NA, 0.32, 0.31, 0.35, -1.11, 0.027, -40.51, 0.0),
							c(NA, NA, 0.32, 0.31, 0.35, -1.11, 0.027, -40.51, 0.0),
							c(NA, NA, 0.32, 0.31, 0.35, -1.11, 0.027, -40.51, 0.0),
							c(NA, NA, 0.32, 0.31, 0.35, -1.11, 0.027, -40.51, 0.0),
...
kbl(data, col.names=d.colnames,  caption="TO BE FIXXXXXXXEDDDDD GAAAAAH Results of the logistic regression to quantify the effect of different parameter values on the odds ratio to detect at least one neighbor. Odds ratio values >1 indicate a higher probability of neighbor detection, while odds ratios <1 indicate a lower probability of neighbor detection.", format="latex", booktabs=T, escape=F, align='c')%>% column_spec(2:9, width=".75cm")
```

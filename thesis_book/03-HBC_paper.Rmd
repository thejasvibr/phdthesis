...
\chaptermark{group echolocation in high duty-cycle bats}


This chapter is a manuscript under preparation:

*Neetash Mysuru Rajagopalachari$^{*}$, Thejasvi Beleyur$^{*}$, Aditya Krishna, Holger R Goerlitz, (2021) High duty-cycle bats in the field do not alter echolocation calls when flying in groups*

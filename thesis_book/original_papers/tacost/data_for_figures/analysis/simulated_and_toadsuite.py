...
plt.ylabel('Error, m', fontsize=15);plt.xlabel('Point distance from central mic, m', fontsize=15)
plt.xticks(fontsize=12);plt.yticks(fontsize=12)
...
plt.xlabel('Point distance from central mic, m', fontsize=15)
plt.xticks(fontsize=12);plt.yticks(fontsize=12)
...
plt.xlabel('Distance from tristar central mic, m', fontsize=15)
plt.xticks(fontsize=12);plt.yticks(fontsize=12)

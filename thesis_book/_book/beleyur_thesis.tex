...
\caption{\label{tab:regressionresults}TO BE FIXXXXXXXEDDDDD GAAAAAH Results of the logistic regression to quantify the effect of different parameter values on the odds ratio to detect at least one neighbor. Odds ratio values >1 indicate a higher probability of neighbor detection, while odds ratios <1 indicate a lower probability of neighbor detection.}
\centering
\begin{tabular}[t]{c>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}>{\centering\arraybackslash}p{.75cm}c}
\toprule
...
\midrule
Intercept &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & \vphantom{6} 0\\
Heading variation ($^{\circ}$) & $\pm$90 & $\pm$ & 1.32 & 1.28 & 1.36 & 0.28 & 0.015 & 18.35 & 0.0\\
Acoustic shadowing & Yes & No & 0.75 & 0.73 & 0.78 & -0.28 & 0.015 & 18.63 & 0.0\\
Interpulse interval (ms) & 25 & 100 & 0.001 & 0.0009 & 0.001 & -6.84 & 0.073 & -93.52 & 0.0\\
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & \vphantom{5} 0\\
\addlinespace
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & \vphantom{4} 0\\
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & \vphantom{3} 0\\
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & \vphantom{2} 0\\
Minimum interbat distance (m) &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & \vphantom{1} 0\\
Sound duration (ms) &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & 0\\
\addlinespace
Source level (dB SPL re 20 $\mu$ Pa at 1m) &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & 0\\
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & 0\\
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & 0\\
 &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & 0\\
Atmospheric attenuation (dB/m) &  &  & 0.32 & 0.31 & 0.35 & -1.11 & 0.027 & -40.51 & 0\\
\bottomrule
\end{tabular}
\end{table}

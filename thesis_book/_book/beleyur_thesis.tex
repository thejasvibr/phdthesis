...
In the face of jamming from other active sensing conspecifics or experimental treatments, individuals show `jamming-avoidance responses' \citep{bullock1972jamming}. \citet{bullock1972jamming}, while working in electric fish that emit `wave-type' electric signals. Wave-type electric fish continuously emit electric discharges at an individual-specific frequency \citep{heiligenberg2012principles}. When faced with an experimental signal that is close to their own emitted frequency, wave-type fish shift their discharge frequency to prevent spectral overlap and deterioration in electrolocation. Another group of electric fish, the `pulse' type fish, emit short electric discharges at intervals. Pulse type electric fish resort to increasing their discharge rate, or adjusting discharges to avoid overlap when faced with interfering experimental pulses \citep{heiligenberg2012principles}. Studies of jamming avoidance in electric fish have helped form the basis of group active sensing, but have remained to my knowledge primarily focused on individual-level responses to experimental treatments, studies with multiple electric fish in the field are recently on the rise \citep{henninger2020tracking}. Another important aspect that may minimise the overall extent of jamming in weakly electric fish is the limited spatial range of their electrolocation \citep{nelson2006a}.

Echolocating bats emit loud ultrasonic calls and detect objects by listening for the echoes reflected by them.

\hypertarget{low-and-high-duty-cycle-echolocation}{%
\subsection{Low and high duty-cycle echolocation}\label{low-and-high-duty-cycle-echolocation}}
...
\hypertarget{sensory-systems}{%
\section{Sensory systems}\label{sensory-systems}}
...
\hypertarget{inverse-problems-all-the-way}{%
\section{Inverse problems all the way}\label{inverse-problems-all-the-way}}
...
\newline
Es ist an der Zeit einen Kreis zu bilden''}\footnote{To all manifested and unmanifested manifestations, humans, animals, opinions, feelings, fractals, cicadas, mutants, shamans, torchbearers, spirit-travelling and micro-encyclopic hunting molluscs, it is about time to form a circle.}
\newline
...
To everyone and everything mentioned above, and especially to all those who I have not specifically mentioned - I convey my gratitude: thank you, Danke, \foreignlanguage{bulgarian}{Благодаря}, \foreignlanguage{kannada}{ಧನ್ಯವಾದಗಳು}.
